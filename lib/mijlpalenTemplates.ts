...
const KNIE_KRUISBAND: MijlpalenTemplate = [
  ...
  { fase: "Fase 1 – Vroeg herstel", title: "Lopen zonder hulpmiddel" },
  // Fase 2
  { fase: "Fase 2 – Beweging",      title: "120° knieflexie bereikt" },
  { fase: "Fase 2 – Beweging",      title: "Traplopen zelfstandig" },
...
const KNIE_KNIEBAND: MijlpalenTemplate = [
  ...
  { fase: "Fase 2 – Beweging",      title: "Fietsen pijnvrij" },
...
const KNIE_PATELLA: MijlpalenTemplate = [
  ...
  { fase: "Fase 2 – Beweging",      title: "Knie volledig buigen" },
...
const ENKEL: MijlpalenTemplate = [
  { fase: "Fase 1 – Vroeg herstel", title: "Zwelling en blauwe plek verdwenen" },
  ...
  { fase: "Fase 2 – Beweging",      title: "Hardlopen op vlakke ondergrond" },
...
const SCHOUDER: MijlpalenTemplate = [
  ...
  { fase: "Fase 1 – Vroeg herstel", title: "Slapen op aangedane zijde mogelijk" },
...
const PEES_ACHILLES: MijlpalenTemplate = [
  ...
  { fase: "Fase 2 – Beweging",      title: "Licht hardlopen pijnvrij" },
  { fase: "Fase 2 – Beweging",      title: "Springen pijnvrij" },
